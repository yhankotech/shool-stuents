...
export function ResourcesView() {
  ...
  const resources = [
    ...
    },
    {
      ...
      subject: 'Física',
      url: '#',
      description: 'Plataforma interativa para simular reações químicas',
    ...
    {
      id: '5',
      title: 'Jogo: Quiz de História Mundial',
      type: 'game',
      subject: 'História',
      url: '#',
      description: 'Jogo educativo sobre eventos históricos mundiais',
